...
<head>
    ...
    <link rel="stylesheet" href= "<?= base_url('Assets/CSS/container_fiche_peugeot5008.css') ?>" >
...
<div class="presentation-produit">
    <div class="titre">
        <h1 class="h3-titre">Peugeot 5008</h1>
    </div>

    <div class="carousel">
        <div class="mySlides"><img src="<?= base_url('Assets/Voiture/Peugeot 5008/1.jpg') ?>" alt="Peugeot 5008" width="350px"
                height="350px"></div>
        <div class="mySlides"><img src="<?= base_url('Assets/Voiture/Peugeot 5008/2.jpg') ?>" alt="Peugeot 5008" width="350px"
                height="350px"></div>
        <div class="mySlides"><img src="<?= base_url('Assets/Voiture/Peugeot 5008/3.jpg') ?>" alt="Peugeot 5008" width="350px"
                height="350px"></div>
        <div class="mySlides"><img src="<?= base_url('Assets/Voiture/Peugeot 5008/4.jpg') ?>" alt="Peugeot 5008" width="350px"
                height="350px"></div>
        <div class="mySlides"><img src="<?= base_url('Assets/Voiture/Peugeot 5008/5.jpg') ?>" alt="Peugeot 5008" width="350px"
                height="350px"></div>
        <div class="mySlides"><img src="<?= base_url('Assets/Voiture/Peugeot 5008/6.jpg') ?>" alt="Peugeot 5008" width="350px"
                height="350px"></div>
        <div class="mySlides"><img src="<?= base_url('Assets/Voiture/Peugeot 5008/7.jpg') ?>" alt="Peugeot 5008" width="350px"
                height="350px"></div>
        <div class="mySlides"><img src="<?= base_url('Assets/Voiture/Peugeot 5008/8.jpg') ?>" alt="Peugeot 5008" width="350px"
                height="350px"></div>
        <div class="mySlides"><img src="<?= base_url('Assets/Voiture/Peugeot 5008/9.jpg') ?>" alt="Peugeot 5008" width="350px"
                height="350px"></div>
        <div class="mySlides"><img src="<?= base_url('Assets/Voiture/Peugeot 5008/10.jpg') ?>" alt="Peugeot 5008" width="350px"
                height="350px"></div>
        <div class="mySlides"><img src="<?= base_url('Assets/Voiture/Peugeot 5008/11.jpg') ?>" alt="Peugeot 5008" width="350px"
                height="350px"></div>
    </div>
...
<div class="description">
    ...
    <div class="contenu">
        <div class="les-infos">
            ...
            <p>
            <p class="kilometre">kilométrage : 96 500KM
            <p>
            <p class="couleur">Couleur extérieur : Bleu Foncé
            <p>
